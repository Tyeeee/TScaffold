...
import com.tscaffold.component.basic.BasicApplication
import com.tscaffold.component.common.ui.viewmodel.MviLog

/**
 * 应用真正的 Application。
 *
 * 它继承 component_basic 里的 [BasicApplication]（那是留给"基础能力初始化"的位置），
