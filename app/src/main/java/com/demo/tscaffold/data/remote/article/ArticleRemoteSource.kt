...
import com.demo.tscaffold.data.article.ArticleSource
// 外层 Envelope 和它的扩展函数（unwrap / unwrapOrNull / checkOk）在父包 data.remote 里，
// 搬进 data.remote.article 之后必须显式 import —— 扩展函数不会跨包自动可见。
import com.demo.tscaffold.data.remote.checkOk
import com.demo.tscaffold.data.remote.unwrap
import com.demo.tscaffold.data.remote.unwrapOrNull
