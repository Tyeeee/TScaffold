...
import com.demo.tscaffold.databinding.ActivityListBinding
import com.demo.tscaffold.ui.detail.compose.DetailActivity
import com.demo.tscaffold.ui.list.contract.ListContract
import com.demo.tscaffold.ui.list.viewmodel.ListViewModel
 ...
 */
class ListActivity :
    BaseActivity<ActivityListBinding, ListViewModel>(
    ...
    private fun showDeleteDialogIfNeeded(pendingDeleteId: Int?) {
        ...
        deleteDialog = AlertDialog.Builder(this)
            .setTitle(R.string.list_delete_title)
            .setMessage(R.string.list_delete_message)
            .setPositiveButton(R.string.list_delete_ok) { _, _ ->
                viewModel.setIntent(ListContract.Intent.ConfirmDelete)
            }
            .setNegativeButton(R.string.list_delete_cancel) { _, _ ->
