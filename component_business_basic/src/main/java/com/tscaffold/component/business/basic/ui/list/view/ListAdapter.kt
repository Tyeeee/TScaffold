package com.tscaffold.component.business.basic.ui.list.view
...
import com.tscaffold.component.business.basic.databinding.BusinessBasicItemArticleBinding
import com.tscaffold.component.business.basic.databinding.BusinessBasicItemListFooterBinding
import com.tscaffold.component.business.basic.ui.list.contract.ListContract
...
class ListAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return if (viewType == TYPE_ITEM) {
            ItemHolder(BusinessBasicItemArticleBinding.inflate(inflater, parent, false))
        } else {
            FooterHolder(BusinessBasicItemListFooterBinding.inflate(inflater, parent, false))
        }
    }
    ...
    inner class ItemHolder(
        private val binding: BusinessBasicItemArticleBinding,
    ...
    inner class FooterHolder(
        private val binding: BusinessBasicItemListFooterBinding,
    ) : RecyclerView.ViewHolder(binding.root) {
        ...
        fun bind(status: ListContract.MoreStatus) {
            when (status) {
                ListContract.MoreStatus.Loading -> {
                    ...
                    binding.tvFooter.setText(R.string.business_basic_list_loading_more)
                    binding.root.isClickable = false
                }

                ListContract.MoreStatus.Failed -> {
                    binding.pbFooter.visibility = android.view.View.GONE
                    binding.tvFooter.setText(R.string.business_basic_list_more_failed)
                ...
                ListContract.MoreStatus.NoMore -> {
                    binding.pbFooter.visibility = android.view.View.GONE
                    binding.tvFooter.setText(R.string.business_basic_list_no_more)
                    binding.root.isClickable = false
                }
